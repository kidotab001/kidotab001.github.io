...
function spawnCoins(deltaTime) {
    ...
    if (yellowCoin.timer > yellowCoin.interval) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            coins.push({
                ...
                y: -coinSize,
                size: coinSize,
                speed: mapRange(coinSize, yellowCoin.minSize, yellowCoin.maxSize, 
                    yellowCoin.maxSpeed, yellowCoin.minSpeed),
                type: 'yellow'
            });
        }
    }
    ...
    if (specialCoin.timer > specialCoin.interval) {
        ...
        coins.push({
            ...
            y: -coinSize,
            size: coinSize,
            speed: mapRange(coinSize, specialCoin.minSize, specialCoin.maxSize, 
                specialCoin.maxSpeed, specialCoin.minSpeed),
